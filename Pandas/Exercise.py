...
# a) fill Rainfall NaNs with median
weather['Rainfall'] = weather['Rainfall'].fillna(weather['Rainfall'].median())

# b) fill any remaining NaNs across the whole DataFrame with 0
